...
async function run(params) {
    ...
    const packageJsonFilesResolved = await (() => {
        ...
        return !pathWithWildcards ?
            undefined :
            (0, resolvePathsWithWildcards_1.resolvePathsWithWildcards)({ pathWithWildcards });
    })();
    const { srcDirPath, tsconfigOutDir } = {
        "srcDirPath": ["src", "lib"].find(sourceDirPath => fs.existsSync(sourceDirPath)),
        "tsconfigOutDir": commentJson.parse(fs.readFileSync(fs.existsSync("./tsproject.json") ? "./tsproject.json" : "./tsconfig.json")
