...
exports.getThirdPartyDenoModuleInfos = (0, addCache_1.addCache)(async (params) => {
    ...
    const latestVersion = await (0, node_fetch_1.default)(`https://cdn.deno.land/${denoModuleName}/meta/versions.json`)
    ...
    const infos = await (0, node_fetch_1.default)(`https://cdn.deno.land/${denoModuleName}/versions/${latestVersion}/meta/meta.json`)
        .then(async (res) => !/^2[0-9]{2}$/.test(`${res.status}`) ?
        undefined :
